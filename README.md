...
- `data/train.jsonl` — исходная обучающая выборка с разметкой;
- `data/train_v3.jsonl` — очищенная и дедуплицированная версия `train_v2`;
...
- [`DATASET_V3.md`](DATASET_V3.md) — воспроизводимый процесс очистки `train_v2`
  и аудит неоднозначных разметок.
